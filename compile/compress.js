...
const zlib = require('zlib');             /*
 ...
 MIT Licensed
*/
const f=require("mime-db"),h=/^text\/|\+(?:json|text|xml)$/i,p=/^\s*([^;\s]*)(?:;|\s|$)/;function w(a){if(!a||"string"!=typeof a)return!1;a=(a=p.exec(a))&&a[1].toLowerCase();const b=f[a];return b&&void 0!==b.compressible?b.compressible:h.test(a)||null};/*
 MIT
 Jonathan Ong
